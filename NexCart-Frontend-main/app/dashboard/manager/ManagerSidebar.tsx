...
const navItems = [
  ...
  {
    href: "/dashboard/manager/activity-logs",
    label: "Activity Logs",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "/dashboard/manager/change-password",
  ...
  return (
    <aside
      className={`${collapsed ? "w-20" : "w-64"
        } min-h-screen bg-gradient-to-b from-slate-900 to-blue-950 flex flex-col transition-all duration-300 shadow-2xl flex-shrink-0`}
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-5 border-b border-white/10">
        {!collapsed && (
          <div className="flex items-center gap-3">
            ...
            <span className="font-black text-white text-lg">Manager</span>
          </div>
        )}
        <button
            ...
            return (
              <li key={item.href}>
                <Link
                  ...
                  className={`flex items-center gap-3 px-3 py-2.5 rounded-xl font-medium text-sm transition-all group ${isActive
      ...
      <div className="p-3 border-t border-white/10">
        <button
          ...
          className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-all font-medium text-sm group"
        >
